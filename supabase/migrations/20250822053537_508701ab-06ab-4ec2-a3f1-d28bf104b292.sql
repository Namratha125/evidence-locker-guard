...
-- Drop the existing policies for evidence viewing
DROP POLICY IF EXISTS "Users can view authorized evidence only" ON public.evidence;
...
CREATE POLICY "Evidence access restricted to case members" 
ON public.evidence 
FOR SELECT 
USING (
